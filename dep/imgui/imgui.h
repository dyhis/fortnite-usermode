...
inline ImColor im_blue(69, 148, 232, 255 );
inline ImColor im_red( 255, 0, 0, 255 );
inline ImColor im_purple( 179, 255, 0, 255 );
inline ImColor im_green( 0, 255, 127, 255 );
inline ImColor im_white( 255, 255, 255, 255 );
inline ImColor im_gray( 158, 160, 163, 255 );
inline ImColor im_black( 15, 15, 15, 255 );

inline ImColor im_purple_0( 200, 255, 100, 255 );
inline ImColor im_green_0( 180, 70, 255, 255 );
inline ImColor im_blue_0( 100, 160, 255, 255 );
inline ImColor im_red_0( 255, 100, 100, 255 );
inline ImColor im_gray_0( 158, 160, 163, 50 );

inline ImColor im_purple_low( 179, 255, 0, 100 );
inline ImColor im_green_low( 128, 0, 255, 100 );
inline ImColor im_blue_low( 0, 90, 255, 100 );
inline ImColor im_red_low( 255, 0, 0, 100 );
inline ImColor im_white_low( 255, 255, 255, 50 );
inline ImColor im_black_low( 25, 25, 25, 50 );

inline ImColor HSLToRGB( float h, float s, float l )
{
	float r, g, b;
	...
	return ImColor( static_cast< int >( r * 255.0f ), static_cast< int >( g * 255.0f ), static_cast< int >( b * 255.0f ) );
}

inline ImColor get_team_color( int id )
{
	if ( id < 0 )
	{
...
static const int virtual_key_codes[] = {
	0x0,  //Undefined
	0x01,
	0x02,
	0x03,
